...
|---|---|---|---|---|
| A | `WP-P2-003` | 完成阶段 A 的 653 个原始来源语义单元人工审核 | 三轮外部搜索已完成并暂停 | 653/653 语义单元均有显式人工判断（已完成） |
...
| I | `WP-P8-001` | 执行全部严格验收并发布当前版本 | `WP-P6-001`、`WP-P7-001` 完成 | 23 项质量门全部通过；当前版本已按有界范围发布 |
...
`WP-P2-005` 已完成：169 个已登记来源已由其精确登记链接核验。`eu-gdpr-official-2016` 的精确 EUR-Lex 链接在 2026-09-04 持续返回 AWS WAF 人机挑战（空 `202` 或 `403`），用户已明确批准将其作为不可访问例外，不再阻塞项目推进。该来源并未核验，且不得作为法律或技术结论的主要证据；后续正式内容应保留这一使用边界。
