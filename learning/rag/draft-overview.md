...
mindmap
  root(("RAG 知识体系"))
    ...
    RAG_04["RAG-04 Chunking · 15 点"]
    RAG_05["RAG-05 Embedding · 14 点"]
    RAG_06["RAG-06 存储与索引 · 15 点"]
    RAG_07["RAG-07 Query 理解 · 12 点"]
    RAG_08["RAG-08 检索、融合与重排 · 16 点"]
    RAG_09["RAG-09 上下文与生成 · 16 点"]
    RAG_10["RAG-10 评估 · 14 点"]
    RAG_11["RAG-11 生产工程与治理 · 19 点"]
    RAG_12["RAG-12 高级范式 · 20 点"]
    RAG_13["RAG-13 项目与面试应用 · 11 点"]
```
